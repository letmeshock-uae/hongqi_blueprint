...
export const models: VehicleModel[] = [
  {
    ...
    trims: [
      ...
      { id: "t2", name: "Exclusive", priceAddon: 50000, description: "Elevated craftsmanship and premium materials" },
      { id: "t3", name: "Flagship", priceAddon: 120000, description: "The pinnacle of Hongqi engineering" },
    ],
    wheels: [
      { id: "w1", name: '19" Classic', image: "/images/wheel-classic.jpg", priceAddon: 0 },
      { id: "w2", name: '20" Sport', image: "/images/wheel-sport.jpg", priceAddon: 15000 },
      { id: "w3", name: '21" Premium', image: "/images/wheel-premium.jpg", priceAddon: 28000 },
    ],
    specs: [
      {
  ...
  },
  {
    ...
    trims: [
      ...
      { id: "t2", name: "Long Range", priceAddon: 80000, description: "690 km range, enhanced battery" },
    ],
    wheels: [
      { id: "w1", name: '21" Aero', image: "/images/wheel-aero.jpg", priceAddon: 0 },
      { id: "w2", name: '22" Executive', image: "/images/wheel-exec.jpg", priceAddon: 22000 },
    ],
    specs: [
      {
        category: "Performance",
